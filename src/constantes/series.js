...
const series = [
  ...
  {
    id: "os-relatos-da-guerra-das-tempestades",
    titulo: "Os Relatos da Guerra das Tempestades",
    descricao:
      "Os Relatos da Guerra das Tempestades, série épica de Brandon Sanderson, se passa em Roshar, um mundo devastado por tempestades sobrenaturais conhecidas como Highstorms. A narrativa acompanha a luta de personagens como Kaladin, Shallan, Dalinar e Szeth em um cenário repleto de intrigas políticas, batalhas épicas e um sistema de magia complexo baseado nos Surgebinders. Enquanto conflitos humanos moldam o destino das nações, uma antiga ameaça, os Voidbringers, ressurge para trazer destruição. A série aborda temas de honra, sacrifício e redenção em uma jornada rica em detalhes e reviravoltas surpreendentes.",
    autor: autores[3],
    ano: 2010,
    imagem:
      "https://wmcurrent.com/wp-content/uploads/2021/03/Stormlight-Archive.png",
    livros: [
      {
        ...
        ano: 2010,
        ordem: 1,
        imagem: "https://m.media-amazon.com/images/I/91gtaGEonIL._SL1500_.jpg",
        link: "https://www.amazon.com.br/dp/6589132682",
      },
      {
        id: "palavras-de-radiância",
        titulo: "Palavras de Radiância",
        autor: autores[3],
        ano: 2014,
        ordem: 2,
        imagem: "https://m.media-amazon.com/images/I/91fa4poe6-L._SL1500_.jpg",
        link: "https://www.amazon.com.br/dp/6589132712",
      },
      {
        id: "sacramentadora",
        ...
        ano: 2017,
        ordem: 3,
        imagem: "https://m.media-amazon.com/images/I/81YyIxG2wyL._SL1500_.jpg",
        link: "https://www.amazon.com.br/dp/6589132968",
      },
    ]
  },
];
