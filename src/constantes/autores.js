...
> *"Um leitor vive mil vidas antes de morrer. O homem que nunca lê vive apenas uma."* - George R.R. Martin
  ...
  },
  {
    ...
    imagem:
      "https://la-roue-du-temps.fr/wp-content/uploads/2023/04/brandon-sanderson-min.webp",
    biografia: `
  # Brandon Sanderson
  
  **Brandon Sanderson** é um aclamado autor norte-americano de ficção fantástica e de ficção científica, conhecido por suas intricadas construções de mundos, sistemas mágicos inovadores e histórias envolventes. Ele nasceu em **19 de dezembro de 1975**, em **Lincoln**, Nebraska, Estados Unidos, e é amplamente reconhecido por suas obras como a série **"Mistborn"** e **"The Stormlight Archive"**, além de ter completado a série **"The Wheel of Time"** (*A Roda do Tempo*) após a morte de Robert Jordan.
  
  ## Início da Vida e Carreira
  Sanderson cresceu em Nebraska e desenvolveu cedo o amor pela escrita. Ele frequentou a **Brigham Young University (BYU)**, onde obteve um bacharelado e um mestrado em Escrita Criativa. Durante a faculdade, ele começou a escrever várias de suas primeiras histórias, mas levou anos até conseguir publicar um livro. Sua grande oportunidade veio em 2005, com a publicação de *Mistborn: The Final Empire* (*Nascidos da Bruma: O Império Final*), que marcou o início de uma carreira prolífica.
  
  ## Obras e Contribuições Literárias
  ### Mistborn
  A série *Mistborn* é uma das obras mais populares de Sanderson, conhecida por seu sistema de magia baseado em metais chamado **alomância**. A trilogia original inclui:
  
  1. **O Império Final** (*The Final Empire*)
  2. **O Poço da Ascensão** (*The Well of Ascension*)
  3. **O Herói das Eras** (*The Hero of Ages*)
  
  Sanderson expandiu o universo Mistborn com livros ambientados em eras posteriores, misturando fantasia com elementos de faroeste e ficção científica.
  
  ### The Stormlight Archive
  Sua série mais ambiciosa é *The Stormlight Archive* (*Arquivo das Tempestades*), uma saga épica planejada em dez volumes. Os livros exploram um mundo devastado por tempestades sobrenaturais e conflitos épicos. Os títulos lançados incluem:
  
  1. **O Caminho dos Reis** (*The Way of Kings*)
  2. **Palavras de Luz** (*Words of Radiance*)
  3. **Juramentada** (*Oathbringer*)
  4. **Ritmo da Guerra** (*Rhythm of War*)
  
  Essa série é parte do **Cosmere**, um universo compartilhado que conecta muitas de suas obras por meio de mitologias e histórias entrelaçadas.
  
  ### The Wheel of Time
  Após a morte de Robert Jordan, Sanderson foi escolhido para concluir a icônica série *The Wheel of Time*. Ele escreveu os últimos três volumes baseando-se nas notas deixadas por Jordan:
  ...
  ### Outras Obras
  Sanderson também é conhecido por séries como *Elantris*, *Warbreaker* e livros voltados para o público jovem, como *Alcatraz vs. the Evil Librarians* e *Skyward*.
  
  ## Legado e Estilo
  Sanderson é celebrado por sua habilidade em criar mundos complexos, sistemas de magia únicos e tramas elaboradas. Ele mantém uma forte conexão com seus fãs, frequentemente compartilhando atualizações de seus projetos e oferecendo dicas sobre escrita. Além disso, ele é professor na BYU, onde ensina escrita criativa, inspirando novos escritores.
  
  ### Vida Pessoal
  Brandon Sanderson é casado com Emily Bushman, que também trabalha na indústria editorial. O casal tem três filhos. Sanderson é membro da Igreja de Jesus Cristo dos Santos dos Últimos Dias e vive em Utah, onde continua a escrever e expandir o Cosmere.
  
  Seu impacto no gênero de fantasia moderna é significativo, com milhões de fãs ao redor do mundo esperando ansiosamente por cada novo lançamento.
  
  ---
  
  > *"A jornada nunca é fácil, mas o esforço é o que a torna digna."* - Brandon Sanderson
    `
  },
];
